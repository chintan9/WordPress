...
main[lang] = {
  ...
  searchreplace : {search_desc : "Find", replace_desc : "Find/Replace"},
  ...
  fullscreen : {desc : "Toggle fullscreen mode (Alt + Shift + G)"},
  media : {desc : "Insert / edit embedded media", edit : "Edit embedded media"},
