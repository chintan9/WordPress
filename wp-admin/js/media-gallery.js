/**
 * This file is used on media-upload.php which has been replaced by
 * media-new.php and upload.php
 *
 * @deprecated 3.5.0
...
jQuery(function($) {
  ...
  $('body').bind('click.wp-gallery', function(e) {
    ...
    if (target.hasClass('wp-set-header')) {
      ...
      img_size =
          $('input[name="attachments[' + id + '][image-size]"]:checked').val();

      /**
       * This AJAX action has been deprecated since 3.5.0, see
